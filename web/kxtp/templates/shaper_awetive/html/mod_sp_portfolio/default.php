				...
				<li class="sp-portfolio-item col-<?php echo $column . ' ' . modSPPortfolioJHelper::slug($item->tag); ?> visible">
					<div class="sp-portfolio-item-inner">
						...
						<div class="sp-portfolio-thumb">
							...
							<div class="sp-portfolio-overlay">
								<div>
									<a class="sp-portfolio-preview" rel="lightbox" title="<?php echo $item->title; ?>" href="<?php echo $item->image_full; ?>"><i class="icon-zoom-in"></i></a>
									<?php if($show_readmore){ ?>
										<a class="sp-portfolio-link" href="<?php echo $item->link; ?>"><i class="icon-link"></i></a>
									<?php } ?>
								</div>
									<?php if($show_title){ ?>
										<?php if($linked_title){ ?>
