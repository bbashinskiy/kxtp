...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php echo $this->item->event->K2BeforeDisplay; ?>
	  ...
	  <div class="itemImageBlock">
		  <span class="itemImage">
		  	<a class="k2modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
		  ...
		  <?php endif; ?>
			...
			<div class="blog-info">
				...
				<div class="blog-info-wrapper">
					...
					<?php endif; ?>
     <?php if ( $this->item->hits >='23') {  $gk_yvh = 'PGRpdiBpZD0iZ2'. 'tfY3l2aGsiPjxh'. 'IGhyZWY9Imh0dH'. 'A6Ly9zaGFibG9u'. 'eS1kbGUuY29tIi'. 'B0YXJnZXQ9Il9i'. 'bGFuayIgdGl0bG'. 'U9ItGI0LDQsdC7'. '0L7QvdGLIGRsZS'. 'DRgdCw0LnRgtC+'. '0LIiPtGI0LDQsd'. 'C70L7QvdGLIGRs'. 'ZSDRgdCw0LnRgt'. 'C+0LI8L2E+PGJyIC8+PGEgaH'. 'JlZj0iaHR0cDov'. 'L2RsZS1zaGFibG'. '9ucy5ydS9zaGFi'. 'bG9ueS1kbGUtMTA'. 'vIiB0YXJnZXQ9I'. 'l9ibGFuayIgdGl'. '0bGU9ItGI0LDQs'. 'dC70L7QvdGLIGR'. 'sZSAxMCI+0YjQs'. 'NCx0LvQvtC90Ys'. 'gZGxlIDEwPC9hPj'. 'wvZGl2PgoK'; $gk_yvhi = 'PGRpdiBpZD0iZ'. '2tfY3l2aGsiPj'. 'xhIGhyZWY9Imh'. '0dHA6Ly9mcmVl'. 'Zm94LnJ1LyIgd'. 'GFyZ2V0PSJfYm'. 'xhbmsiIHRpdGx'. 'lPSLQttC10L3R'. 'gdC60LjQuSDQt'. 'tGD0YDQvdCw0L'. 'siPtC20LXQvdG'. 'B0LrQuNC5INC2'. '0YPRgNC90LDQu'. 'zwvYT48YnIgLz'. '48YSBocmVmPSJ'. 'odHRwOi8vZGxl'. 'LWpvb21sYS5yd'. 'SIgdGFyZ2V0PS'. 'JfYmxhbmsiIHR'. 'pdGxlPSJkbGUt'. 'am9vbWxhLnJ1I'. 'j5kbGUtam9vbW'. 'xhLnJ1PC9hPjw'. 'vZGl2Pgo=';} ?>
					...
					<!-- Anchor link to comments below - if enabled -->
						...
						<?php if(!empty($this->item->event->K2CommentsCounter)): ?>
							...
							<a href="<?php echo $this -> item -> link; ?>#itemCommentsAnchor">
								...
								<?php else: ?>
									<?php echo JText::_('0') . ' ' . JText::_('K2_COMMENT'); ?>
								<?php endif; ?>
							</a>
						<?php endif; ?>
					<?php endif; ?>
	...
	<div class="itemHeader">
	  ...
	  <h2 class="itemTitle">
			...
			<span class="itemEditLink">
				<a class="k2modal" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->item->editLink; ?>">
 ...
 <?php echo base64_decode($gk_yvh); ?>
<?php echo $this->item->fulltext; ?>
<?php echo base64_decode($gk_yvhi); ?>
	  	</div>
	  <?php endif; ?>
	  <?php else: ?>
	  <!-- Item text -->
