...
function addActionsButtons(id, zoneBoutonSuppression, evt){
	...
	zoneFade.addClass("acyeditor_mask");
	...
	jQuery(zoneAction).addClass("acyeditor_action");
	...
	jQuery(zoneCopyButton).addClass("acyeditor_copyButton");
	jQuery(zoneCopyButton).addClass("acyeditor_copyButtonBefore");
	...
	jQuery(zoneCopyAfterButton).addClass("acyeditor_copyButton");
	jQuery(zoneCopyAfterButton).addClass("acyeditor_copyButtonAfter");
...
function duplicateZone(id, zoneCopy, action){
	...
	InitContent(id, txtSup, titlSup, titleEd, urlSite);
}
